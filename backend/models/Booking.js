...
const bookingSchema = new mongoose.Schema({
  ...
  status: { 
    type: String, 
    enum: ['pending', 'confirmed', 'checked_in', 'cancelled', 'completed', 'PENDING', 'CONFIRMED', 'CHECKED_IN', 'CANCELLED', 'COMPLETED'], 
    default: 'CONFIRMED' 
  },
  
  // Feature 14: Escrow Protection & Physical Check-In Handshake
  escrowStatus: {
    type: String,
    enum: ['HELD_IN_ESCROW', 'RELEASED_TO_PARTNER', 'REFUNDED_TO_TRAVELER', 'DISPUTED'],
    default: 'HELD_IN_ESCROW'
  },
  checkInOtp: { type: String, select: true },
  checkInOtpHash: { type: String },
  checkInOtpExpiresAt: { type: Date },
  ...
  // Feature 3: One-Tap Reverse Rental / Re-allocation
  isReverseRentalAvailable: { type: Boolean, default: false },
  reverseRentalReassignedTo: { type: mongoose.Schema.Types.ObjectId, ref: 'User' },
