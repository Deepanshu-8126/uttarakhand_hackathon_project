...
const AdminDashboard = () => {
  ...
  return (
    <div className="py-12 pb-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto min-h-screen">
      <div className="bg-warm-white rounded-3xl p-8 card-shadow">
        <div className="flex justify-between items-center mb-8 border-b border-gray-200 pb-4">
          ...
          <div className="flex items-center gap-3">
            <Link 
              to="/audit" 
              className="px-4 py-2 rounded-xl bg-[#0f172a] hover:bg-slate-800 text-emerald-400 border border-slate-700 font-mono text-xs font-bold transition-all flex items-center gap-1.5 shadow-sm"
            >
              <span>⚡ Product Health & Audit Tower</span>
            </Link>
            <button onClick={logout} className="text-red-500 font-bold hover:underline text-sm">
              Logout
            </button>
          </div>
        </div>
