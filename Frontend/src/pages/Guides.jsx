...
const Guides = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#fdfbf7]">
      ...
      <main className="flex-grow flex flex-col items-center px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto w-full pb-20">
        ...
        {/* Guide Grid */}
        <div id="guides-grid" className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 w-full mb-12 scroll-mt-24">
          {loading ? (
