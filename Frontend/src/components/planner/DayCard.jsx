  ...
  return (
    ...
    >
      ...
      <div className="mt-6 space-y-6">
        ...
        {/* ── 8. 🛵 YOUR SCOOTY / RENTAL (WITH OTP HANDSHAKE STATUS) ─── */}
        {(currentRental || day.dayNumber === 1) && (
          <div>
            <h3 className="text-xs font-black uppercase tracking-wider text-slate-400 mb-2.5 flex items-center justify-between">
              <span className="flex items-center gap-2">
                <Bike size={15} className="text-forest-green" />
                <span>Vehicle Rental &amp; Pickup (Day {day.dayNumber})</span>
              </span>
            ...
            <div className="p-4 rounded-2xl bg-slate-50 border border-slate-200 flex flex-col sm:flex-row sm:items-center justify-between gap-3">
              <div className="flex items-center gap-3.5">
                ...
                <div>
                  <div className="flex items-center gap-2 flex-wrap">
                    <h4 className="text-sm font-black text-slate-900">
                      {currentRental?.name || 'Himalayan Royal Enfield / 125cc Scooty'}
                    </h4>
