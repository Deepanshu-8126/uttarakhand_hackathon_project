    ...
    <>
      ...
      >
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="flex items-center gap-1.5">
                <h1 className="font-bold text-base tracking-tight text-white m-0">Discovery Uttarakhand</h1>
                <span className="text-[10px] font-bold px-1.5 py-0.5 rounded bg-emerald-500/20 text-emerald-400 border border-emerald-500/30">
                  GIS
                </span>
              </div>
              <p className="text-xs text-slate-400 m-0">Devbhoomi AI Map Explorer</p>
            </div>
          </div>
        ...
        <div className="p-3 border-t border-slate-800/80 bg-slate-950/60 flex items-center justify-between text-[11px] text-slate-400">
          ...
          <span className="text-emerald-400 font-semibold">Discovery Uttarakhand Edition</span>
        </div>
      </aside>
    </>
  );
