...
export default function GlobalAiCopilotLauncher() {
  ...
  // Hide Copilot Launcher on Profile Page, Copilot Workspace, Admin, Partner, Checkout & Auth Pages
  ...
  const isLoginPage = location.pathname.startsWith('/login') || location.pathname.startsWith('/register');
  ...
  }, [location.pathname, shouldHide, isOpen]);
